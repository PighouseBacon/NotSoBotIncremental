function oops (id, other)
    if id == 0 then
        ...
        elseif input[2] ~= nil then
            ...
            print("For example, using the tag correctly would look something like this: ``{prefix}t {tagname} fe12be [command]``")
            print("You can find the full list of commands by doing ``{prefix}t {tagname} help commands``!")
            print("You can also do ``{prefix}t {tagname} help [subject]`` for a description of a subject in the game.")
