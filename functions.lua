function oops (id, other)
    if id == 0 then
        ...
        elseif input[2] ~= nil then
            ...
            print("You can find the full list of commands by doing ``{prefix}t incremental help commands``!")
            print("You can also do ``{prefix}t incremental help [subject]`` for a description of a subject in the game.")
